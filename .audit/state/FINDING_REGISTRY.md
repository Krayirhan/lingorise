...
| CORE-003 | P3 | Core correctness / Testing | OPEN | RUN-001-BASELINE | RUN-001-BASELINE | archiveDailyQuests/bringForward untested |
| ARCH-001 | P3 | Architecture | OPEN (scope corrected) | RUN-001-BASELINE | FIX-2026-08-25-02 | One dead duplicate file (i18n/formatters.ts only) |
...
| DEP-001 | P4 | Dependency health | OPEN | RUN-001-BASELINE | RUN-001-BASELINE | No vulnerability scan executed |
